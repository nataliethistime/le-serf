...
const taskDefinitions = [
...

  {
    ...
    platforms: ['cli', 'web'],
    TaskClass: require('./docked-ships'),
    defaults: {
      planet: ''
    }
  },
...

  {
    name: 'scuttle-ships',
    title: 'Scuttle Ships',
    description: 'Cear out your Space Ports',
    platforms: ['cli', 'web'],
    TaskClass: require('./scuttle-ships'),
    defaults: {
      planet: '',
      type: '',
      all: false
